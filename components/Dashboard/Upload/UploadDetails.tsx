  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        ...
        <Skeleton className="h-48 w-75 rounded-lg" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="grid gap-2">
                    ...
                    {watchCoverImage ? (
                      <div className="relative w-full aspect-3/4 max-w-50 rounded-lg overflow-hidden border border-gray-200 group">
                        <img
                          src={watchCoverImage}
                          alt="Book cover"
                      ...
                      <div
                        ...
                        className="w-full aspect-3/4 max-w-50 bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                      >
